...
TYPE_TASK = [(1,'Закупки'),(2,'Работа'),(3,'Документация')]
...
class Project(models.Model):
    ...
    date = models.DateField(verbose_name='Дата создания', blank=True, null=True, default=timezone.now)
...
class Task(models.Model):
    type = models.IntegerField(choices=TYPE_TASK, default=2, verbose_name='Тип работы')
    ...
    responsible = models.ForeignKey(Profile, on_delete=models.CASCADE, verbose_name='Ответсвенный')
    prev_task = models.ManyToManyField('self', blank=True, null=True, verbose_name='Предыдущая работа')
    ...
    master = models.ForeignKey('MasterTask', blank=True, null=True, on_delete=models.SET_NULL, related_name='master', verbose_name='Работа родитель')
